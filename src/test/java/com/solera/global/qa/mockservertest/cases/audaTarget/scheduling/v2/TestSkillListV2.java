...
import com.solera.global.qa.mockservertest.expecations.audatarget.scheduling.v2.SkillListV2;
...
@SpringBootTest
@DisplayName("audatarget.scheduling.v2.SkillListV2")
@Duration
@ExtendWith(SkillListV2.class)
class TestSkillListV2 extends MockServerTestBase implements LifecycleLogger {
  ...
  void testGetStatusCode200() throws Exception {
    ...
    Assertions.assertThat(actualResult).isEqualTo(SkillListV2.getSkillResult());
  }
